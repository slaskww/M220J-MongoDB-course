...
@Component
public class MovieDao extends AbstractMFlixDao {  //DAO = Data access object)
...
*/
  ...
  public List<Document> getMoviesByCountry(String... country) {
    ...
    //TO DO = done> Ticket: Projection - implement the query and projection required by the unit test
  ...
  public List<Document> getMoviesByCast(String sortKey, int limit, int skip, String... cast) {
    ...
    //TO DO = done> Ticket: Subfield Text Search - implement the expected cast
    // filter and sort
    List<Document> movies = new ArrayList<>();
    moviesCollection
        .find(castFilter)
  ...
  public List<Document> getMoviesCastFaceted(int limit, int skip, String... cast) {
    ...
    // TO DOne > Ticket: Faceted Search - build the aggregation pipeline by adding all stages in the
