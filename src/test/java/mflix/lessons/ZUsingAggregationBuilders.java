...
public class ZUsingAggregationBuilders extends AbstractLesson {
  ...
  public void complexStages() {
    ...
    /*
    To exemplify/visualize this scenario, let's go ahead and do the following:
    - create facets of the movie documents that were produced in Portugal
    ...
    For the cast_members we need to unwind the cast arrays and use group
  ...
  /*
  Let's recap:
  - Aggregation framework pipelines are composed of lists of Bson stage document objects
