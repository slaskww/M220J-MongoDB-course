...
@SpringBootTest
public class ZUsingPojoLesson extends AbstractLesson {

  private ObjectId actor1Id;
  private ObjectId actor2Id;

  public ZUsingPojoLesson() {
    super();
  }
  ...
  public void testMappingDocumentsToActorClass() {
    ...
    Document actorDocument = actors.find(new Document("_id", actor1Id)).iterator().tryNext(); //FIND() zwraca kursor (wskaznik do miejsca w pamieci), wiec wykorzystujemy tryNext() by zwrocic wartosc
